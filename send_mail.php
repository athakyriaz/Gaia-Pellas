...
if(!$error) 
{
	$_SESSION['mail_send']=true; mail('mastnr@gmail.com',$lastname.' '.$name.' από GaiaPellas.gr',$message,"From:".$email); 
	$_SESSION['mail_send']=true; mail('info@gaiapellas.gr',$lastname.' '.$name.' από GaiaPellas.gr',$message,"From:".$email); 
}
